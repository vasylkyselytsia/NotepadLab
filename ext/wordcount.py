...
class WordCount(QtWidgets.QDialog):
    ...
    def initUI(self):
        currentLabel = QtWidgets.QLabel("Вибрана область", self)
        currentLabel.setStyleSheet("font-weight:bold; font-size: 15px;")

        currentWordsLabel = QtWidgets.QLabel("Слів: ", self)
        currentSymbolsLabel = QtWidgets.QLabel("Символів: ", self)

        self.currentWords = QtWidgets.QLabel(self)
        self.currentSymbols = QtWidgets.QLabel(self)

        totalLabel = QtWidgets.QLabel("Загалом", self)
        totalLabel.setStyleSheet("font-weight:bold; font-size: 15px;")

        totalWordsLabel = QtWidgets.QLabel("Слів: ", self)
        totalSymbolsLabel = QtWidgets.QLabel("Символів: ", self)
        ...
        self.setWindowTitle("Кількість слів")
